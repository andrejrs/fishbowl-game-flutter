...
class _GameScreenState extends State<GameScreen> {
  ...
  void _nextRoundOrEnd(int numTeams, int numRounds) {
    if (_roundIdx < numRounds - 1) {
      ...
      Navigator.pushReplacementNamed(
        context,
        '/results',
        arguments: {'teamScores': _teamScores},
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    final List<List<String>> teams = (args['teams'] as List)
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Round ${_roundIdx + 1} of 3 - ${roundNames[_roundIdx]}',
      ...
      body: Center(
        child: Stack(
          ...
          children: [
            ...
            // Circular countdown overlapping half blue, half white
            if (_isPlaying)
              Positioned(
                top: 0, // places it at the top of the white container
                child: Transform.translate(
                  offset: const Offset(0, -33), // adjust this to move up/down
  ...
  static const List<String> roundNames = ['Taboo', 'Charades', 'One Word'];
